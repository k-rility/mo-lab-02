...
class SimplexMethod:
    ...
    def __init__(self, A, c, b):
        ...
        self.DualSimplexTable = copy.deepcopy(self.SimplexTable).transpose() * (-1)

        self.RowNum, self.ColNum = self.SimplexTable.shape
        self.SimplexTable[self.RowNum - 1] *= -1
        self.DualSimplexTable[-1] *= -1
    ...
    def search_dual(self):
        self.SimplexTable = copy.deepcopy(self.DualSimplexTable)
        self.OldSimplexTable = copy.deepcopy(self.DualSimplexTable)
        self.ref_solution()
